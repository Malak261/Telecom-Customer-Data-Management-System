<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewSubscribedServicePlans.aspx.cs" Inherits="AdminViewSubscribedServicePlans" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>View Subscribed Service Plans</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <!-- Submit Button -->
            <asp:Button ID="Button1" runat="server" Text="View Subscribed Plans" CssClass="submit-btn" OnClick="Button1_Click" />
