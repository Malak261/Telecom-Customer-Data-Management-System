<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerTop.aspx.cs" Inherits="CustomerTop" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <!-- Submit Button -->
            <asp:Button ID="ButtonSubmit" runat="server" Text="View Top 10 Payments" CssClass="submit-btn" OnClick="ButtonSubmit_Click" />
        ...
        <div class="grid-container">
            <asp:GridView ID="GridViewPayments" runat="server" AutoGenerateColumns="true" CssClass="table" />
        </div>
    </form>
</body>
</html>
