<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewPhysicalStoreRedeemedVouchers.aspx.cs" Inherits="AdminViewPhysicalStoreRedeemedVouchers" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin View Physical Store Redeemed Vouchers</title>
    <style>
        body {
...
<body>
    <div class="main">
        ...
        <!-- Title for the page -->
        <div class="title">Admin View Physical Store Redeemed Vouchers</div>
        ...
        <form id="form1" runat="server">
            <div id="gridContainer" class="grid-container">
                <asp:GridView ID="gridPhysicalStoreVouchers" runat="server" AutoGenerateColumns="true" CssClass="table"></asp:GridView>
            </div>
        </form>
    </div>
