<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerRedeemVoucher.aspx.cs" Inherits="CustomerRedeemVoucher" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CustomerRedeemVoucher</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="header">
            Redeem a Certain Voucher ID
        </div>

        <div class="form-container">
            <!-- Mobile Number Input -->
            <asp:TextBox ID="TextBoxMobile" runat="server" placeholder="Enter Mobile Number" />
            <asp:TextBox ID="TextBoxVoucherID" runat="server" placeholder="Enter Voucher ID" />

            <!-- Label for error or success message -->
            <asp:Label ID="MessageLabel" runat="server" CssClass="message" />

            <!-- Submit Button -->
            <asp:Button ID="SubmitButton" runat="server" Text="Redeem Voucher" CssClass="submit-btn" OnClick="SubmitButton_Click" />
