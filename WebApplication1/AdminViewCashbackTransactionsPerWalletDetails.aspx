<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewCashbackTransactionsPerWalletDetails.aspx.cs" Inherits="AdminViewCashbackTransactionsPerWalletDetails" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin View Cashback Transactions Per Wallet Details</title>
    <style>
        body {
...
<body>
    <div class="main">
        ...
        <!-- Title for the page -->
        <div class="title">Admin View Cashback Transactions Per Wallet Details</div>
        ...
        <form id="form1" runat="server">
            <div id="gridContainer" class="grid-container">
                <asp:GridView ID="gridCashbackTransactions" runat="server" AutoGenerateColumns="true" CssClass="table"></asp:GridView>
            </div>
        </form>
    </div>
