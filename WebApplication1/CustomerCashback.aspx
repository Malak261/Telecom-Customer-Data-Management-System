<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerCashback.aspx.cs" Inherits="CustomerCashback" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            ...
            <div class="title">Cashback Transactions</div>
            <div class="form-container">
                <div class="form-group">
                    <label for="texty1">National ID</label>
                    <asp:TextBox ID="texty1" runat="server" placeholder="Enter National ID"></asp:TextBox>
                </div>
