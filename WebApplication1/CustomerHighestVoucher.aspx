<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerHighestVoucher.aspx.cs" Inherits="CustomerHighestVoucher" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Voucher with Highest Value</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <!-- Submit Button -->
            <asp:Button ID="ButtonSubmit" runat="server" Text="View Highest Voucher" CssClass="submit-btn" OnClick="ButtonSubmit_Click" />
        ...
        <div class="grid-container">
            <asp:GridView ID="GridViewVoucher" runat="server" AutoGenerateColumns="true" CssClass="table" />
        </div>
    </form>
</body>
</html>
