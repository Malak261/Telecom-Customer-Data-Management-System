<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerBalancePayment.aspx.cs" Inherits="CustomerBalancePayment" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Customer Balance Payment</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <!-- Amount Input -->
            <asp:TextBox ID="TextBoxAmount" runat="server" placeholder="Enter Amount" />
            ...
            <!-- Submit Button -->
            <asp:Button ID="ButtonSubmit" runat="server" Text="Submit Payment" CssClass="submit-btn" OnClick="ButtonSubmit_Click" />
