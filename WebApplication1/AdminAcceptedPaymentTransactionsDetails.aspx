<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminAcceptedPaymentTransactionsDetails.aspx.cs" Inherits="AdminAcceptedPaymentTransactionsDetails" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin Accepted Payment Transactions Details</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="header">
            Admin Accepted Payment Transactions Details
        </div>
        ...
        <div class="form-container">
            ...
            <!-- Submit Button -->
            <asp:Button ID="Button1" runat="server" Text="View Payment Transactions" CssClass="submit-btn" OnClick="Button1_Click" />
        ...
        <div class="grid-container">
            <asp:GridView ID="gridName2" runat="server" AutoGenerateColumns="false" CssClass="table">
                <Columns>
                    <asp:BoundField DataField="NumberOfTransactions" HeaderText="Number of Transactions" />
                    <asp:BoundField DataField="TotalEarnedPoints" HeaderText="Total Earned Points" />
                </Columns>
            </asp:GridView>
        </div>
    </form>
