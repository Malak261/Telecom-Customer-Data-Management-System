<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewWalletDetails.aspx.cs" Inherits="AdminViewWalletDetails" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin View Wallet Details</title>
    <style>
        body {
...
<body>
    <div class="main">
        ...
        <!-- Title for the page -->
        <div class="title">Admin View Wallet Details</div>
        ...
        <form id="form1" runat="server">
            <div id="gridContainer" class="grid-container">
                <asp:GridView ID="gridWalletDetails" runat="server" AutoGenerateColumns="true" CssClass="table"></asp:GridView>
            </div>
        </form>
    </div>
