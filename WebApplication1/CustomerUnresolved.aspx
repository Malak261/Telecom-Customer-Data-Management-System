<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerUnresolved.aspx.cs" Inherits="CustomerUnresolved" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            <!-- National ID Input -->
            <asp:TextBox ID="TextBoxNID" runat="server" placeholder="Enter National ID" />
            
            <!-- Label for error or success message -->
            <asp:Label ID="LabelMessage" runat="server" ForeColor="Red" />

            <!-- Submit Button -->
            <asp:Button ID="ButtonSubmit" runat="server" Text="View Unresolved Tickets" CssClass="submit-btn" OnClick="ButtonSubmit_Click" />
        ...
        <div class="grid-container">
            <asp:GridView ID="GridViewTickets" runat="server" AutoGenerateColumns="true" CssClass="table" />
        </div>
    </form>
</body>
</html>