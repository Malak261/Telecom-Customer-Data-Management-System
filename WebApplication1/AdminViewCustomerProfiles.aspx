<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewCustomerProfiles.aspx.cs" Inherits="AdminViewCustomerProfiles" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin View Customer Profiles</title>
    <style>
        body {
...
<body>
    <div class="main">
        ...
        <!-- Title for the page -->
        <div class="title">Admin View Customer Profiles</div>
        ...
        <form id="form1" runat="server">
            <div id="gridContainer" class="grid-container">
                <asp:GridView ID="gridCustomerProfiles" runat="server" AutoGenerateColumns="true" CssClass="table"></asp:GridView>
            </div>
        </form>
    </div>
