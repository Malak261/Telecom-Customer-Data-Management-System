<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminViewResolvedTickets.aspx.cs" Inherits="AdminViewResolvedTickets" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin View Resolved Tickets</title>
    <style>
        body {
...
<body>
    <div class="main">
        ...
        <!-- Title for the page -->
        <div class="title">Admin View Resolved Tickets</div>
        ...
        <form id="form1" runat="server">
            <div id="gridContainer" class="grid-container">
                <asp:GridView ID="gridResolvedTickets" runat="server" AutoGenerateColumns="true" CssClass="table"></asp:GridView>
            </div>
        </form>
    </div>
