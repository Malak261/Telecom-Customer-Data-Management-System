<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminShowTotalUsage.aspx.cs" Inherits="AdminShowTotalUsage" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Show Total Usage</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            ...
            <div class="title">Show Total Usage</div>
            <div class="form-container">
                ...
                <asp:Button ID="Button1" runat="server" CssClass="show-details" Text="Show Total Usage" OnClick="Button1_Click" />
